...
var init = function(W, H) {
    ...
    // // 旋转（暂无）
    // that.rotateImage = function() {
    //     var that = this
    // }

    // // 加载图片，绘制到canvas中
    // that.loadImage = function(src, width, height) {
    //     var that = this
    //     var cropperData = that.data.cropperData
    ...
    // // 适应屏幕的size
    // that.adjustSize = function(width, height) {
    //     if (width > W) {
    ...
    // // 绘制选择框
    // that.drawLines = function(items, key) {
    //     var that = this
    //     var cropperData = that.data.cropperData
    ...
    // that.setupMoveItem = function(key, changedTouches, callback)  {
    //     var that = this
    //     var cropperData = that.data.cropperData
    //     var items = cropperData.items
